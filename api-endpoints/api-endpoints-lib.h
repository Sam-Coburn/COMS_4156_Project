...
virtual crow::response postSignUp(const crow::request& req);
virtual crow::response postLogin(const crow::request& req);
virtual crow::response deleteLogin(const crow::request& req);
